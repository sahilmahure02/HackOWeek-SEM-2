      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        >
          ...
          <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
            ...
            <span className="text-sm text-white/90">New Cohort Starting January 2026</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto mb-10">
            Join our intensive bootcamp and master React, Node.js, databases, and modern deployment. 
            Go from beginner to job-ready with real-world projects and expert mentorship.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a
              href="#pricing"
              className="group px-8 py-4 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-bold text-lg rounded-full hover:shadow-2xl hover:shadow-violet-500/30 transition-all duration-300 hover:-translate-y-1 flex items-center"
            >
              Start Your Journey
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { number: '$85K', label: 'Avg Starting Salary' },
